...
<html>
  <head>
    ...
    <title>Update Course - Student Course Manager</title>
  ...
  <body>
    ...
    <div class="container main_component">
      <h1 class="page-title"><i class="fa-solid fa-edit"></i> Update Course</h1>
      ...
      <div class="form-container">
        <form:form
          action="/courses/update/${course.id}"
          method="post"
        ...
        >
          ...
          <div class="form-group">
            <label for="code"
              ><i class="fa-solid fa-code"></i> Course Code:</label
            >
          ...
          <div class="form-group">
            <label for="name"
              ><i class="fa-solid fa-book"></i> Course Name:</label
            >
          ...
          <div class="form-group">
            <label for="creditHours"
              ><i class="fa-solid fa-clock"></i> Credits:</label
            >
            <form:input
              path="creditHours"
              id="creditHours"
          ...
          <div class="form-group">
            <label for="description"
              ><i class="fa-solid fa-align-left"></i> Description:</label
            >
